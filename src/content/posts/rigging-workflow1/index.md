---
title: "rigging-workflow #1 - data-centric, asset 자동화에 대한 생각 정리"
date: 2025-11-25
...
실제 api 는 아니지만 domino 의 build함수는 아래의 순서대로 데이터를 가져와 build 하게 된다.
``` python
# rig 생성
for component in components:
	create_modular_rigging()
